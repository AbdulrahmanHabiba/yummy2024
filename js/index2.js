...
const displayAreasAndIngredientsNames = (array, title, description, icon, type) => {
    ...
    array.forEach((meal, ndx) => {
        ...
        mealHtml = `
            <div class="col-sm-6 col-xs-6 col-md-3 col-lg-3 py-2">
                <div onclick="${clickHandler}" class="meal w-100 h-100 p-3 rounded-2 light-mode overflow-hidden d-flex flex-column justify-content-center align-items-center ">
...
const getCategoryMeals = (categoryName) => {
    ...
    const url = `https://www.themealdb.com/api/json/v1/1/filter.php?i=${categoryName}`
    getMeals(url)
}
